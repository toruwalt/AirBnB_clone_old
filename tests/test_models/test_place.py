#!/usr/bin/python3
"""This define unittests for models/place.py.
...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_two_places_unique_ids(self):
        pl_1 = Place()
        pl_2 = Place()
        self.assertNotEqual(pl_1.id, pl_2.id)

    def test_two_places_different_created_at(self):
        pl_1 = Place()
        sleep(0.05)
        pl_2 = Place()
        self.assertLess(pl_1.created_at, pl_2.created_at)

    def test_two_places_different_updated_at(self):
        pl_1 = Place()
        sleep(0.05)
        pl_2 = Place()
        self.assertLess(pl_1.updated_at, pl_2.updated_at)
