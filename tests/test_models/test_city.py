#!/usr/bin/python3
"""This define unittests for models/city.py.
...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_two_cities_unique_ids(self):
        cy_1 = City()
        cy_2 = City()
        self.assertNotEqual(cy_1.id, cy_2.id)

    def test_two_cities_different_created_at(self):
        cy_1 = City()
        sleep(0.05)
        cy_2 = City()
        self.assertLess(cy_1.created_at, cy_2.created_at)

    def test_two_cities_different_updated_at(self):
        cy_1 = City()
        sleep(0.05)
        cy_2 = City()
        self.assertLess(cy_1.updated_at, cy_2.updated_at)
